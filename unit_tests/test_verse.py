...
"""
Module for testing verse module and vrsent (verse entities) module
"""
...
class TestSession(vrsent.VerseSession):
    ...
    def cb_receive_connect_accept(self, user_id, avatar_id):
        ...
        super(TestSession, self).cb_receive_connect_accept(user_id, avatar_id)
    ...
    def cb_receive_node_create(self, node_id, parent_id, user_id, custom_type):
        ...
        command node_create
        """
        node = super(TestSession, self).cb_receive_node_create(node_id, parent_id, user_id, custom_type)
        ...
        if node_id == self.avatar_id:
            ...
            try:
                ...
                self.scene_node = vrsent.VerseNode(
                    session=self,
                    node_id=3,
            ...
            self.test_scene_node = vrsent.VerseNode(
                session=self,
                node_id=None,
            ...
            self.test_node = vrsent.VerseNode(
                session=self,
                node_id=None,
                parent=None,
                user_id=None,
            ...
            self.test_link_node = vrsent.VerseNode(
                session=self,
                node_id=None,
            ...
            self.test_destroy_node = vrsent.VerseNode(
                session=self,
                node_id=None,
                parent=None,
                user_id=None,
            ...
            self.test_node.test_tg.test_tag = vrsent.VerseTag(
                tg=self.test_node.test_tg,
                tag_id=None,
            ...
            self.test_node.test_tg.test_destroy_tag = vrsent.VerseTag(
                tg=self.test_node.test_tg,
                tag_id=None,
                data_type=vrs.VALUE_TYPE_UINT8,
                custom_type=65,
            ...
            # Create test layer
            self.test_node.test_layer = vrsent.VerseLayer(
                node=self.test_node,
                parent_layer=None,
                data_type=vrs.VALUE_TYPE_UINT8,
                count=1,
            ...
            self.test_node.test_child_layer = vrsent.VerseLayer(
                node=self.test_node,
            ...
            self.test_node.test_destroy_layer = vrsent.VerseLayer(
                node=self.test_node,
                parent_layer=None,
                data_type=vrs.VALUE_TYPE_UINT8,
                count=1,
                custom_type=130)
            # Create child layer of destroy layer
            self.test_node.test_destroy_child_layer = vrsent.VerseLayer(
                node=self.test_node,
            ...
            # Create node that is not automatically subscribed
    ...
    def cb_receive_node_destroy(self, node_id):
        ...
        """
        node = super(TestSession, self).cb_receive_node_destroy(node_id)
    ...
    def cb_receive_node_link(self, parent_node_id, child_node_id):
        ...
        link between nodes
        """
        child_node = super(TestSession, self).cb_receive_node_link(parent_node_id, child_node_id)
    ...
    def cb_receive_node_lock(self, node_id, avatar_id):
        ...
        this node.
        """
        locked_node = super(TestSession, self).cb_receive_node_lock(node_id, avatar_id)
    ...
    def cb_receive_node_unlock(self, node_id, avatar_id):
        ...
        this node.
        """
        unlocked_node = super(TestSession, self).cb_receive_node_unlock(node_id, avatar_id)
    ...
    def cb_receive_taggroup_create(self, node_id, taggroup_id, custom_type):
        ...
        tag group create
        """
        tg = super(TestSession, self).cb_receive_taggroup_create(node_id, taggroup_id, custom_type)
        try:
    ...
    def cb_receive_taggroup_destroy(self, node_id, taggroup_id):
        ...
        tag group destroy
        """
        tg = super(TestSession, self).cb_receive_taggroup_destroy(node_id, taggroup_id)
        try:
            test_destroy_tg = self.test_node.test_destroy_tg
        except AttributeError:
            test_destroy_tg = None
    ...
    def cb_receive_tag_create(self, node_id, taggroup_id, tag_id, data_type, count, custom_type):
        ...
        """
        tag = super(TestSession, self).cb_receive_tag_create(
            node_id,
            taggroup_id,
            tag_id,
            data_type,
    ...
    def cb_receive_tag_destroy(self, node_id, taggroup_id, tag_id):
        ...
        """
        tag = super(TestSession, self).cb_receive_tag_destroy(node_id, taggroup_id, tag_id)
        try:
            test_destroy_tag = self.test_node.test_tg.test_destroy_tag
        except AttributeError:
            test_destroy_tag = None
    ...
    def cb_receive_tag_set_values(self, node_id, taggroup_id, tag_id, value):
        ...
        """
        tag = super(TestSession, self).cb_receive_tag_set_values(node_id, taggroup_id, tag_id, value)
        try:
            test_new_tag = self.test_node.test_tg.test_tag
        except AttributeError:
            test_new_tag = None
    ...
    def cb_receive_layer_create(self, node_id, parent_layer_id, layer_id, data_type, count, custom_type):
        ...
        """
        layer = super(TestSession, self).cb_receive_layer_create(
            node_id,
            parent_layer_id,
            layer_id,
            data_type,
    ...
    def cb_receive_layer_destroy(self, node_id, layer_id):
        ...
        """
        layer = super(TestSession, self).cb_receive_layer_destroy(node_id, layer_id)
    ...
    def cb_receive_layer_set_value(self, node_id, layer_id, item_id, value):
        ...
        """
        layer = super(TestSession, self).cb_receive_layer_set_value(node_id, layer_id, item_id, value)
    ...
    def cb_receive_layer_unset_value(self, node_id, layer_id, item_id):
        ...
        """
        layer = super(TestSession, self).cb_receive_layer_unset_value(node_id, layer_id, item_id)
        # TODO: add test
